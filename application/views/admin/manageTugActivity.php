<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <button type="button" class="btn btn-primary" onclick="addData('Tambah Kegiatan Tug', 'tugactivity')">Tambah Kegiatan Tug <i class="bx bx-plus"></i></button>
      <div class="table-responsive-lg">
        <table id="tugActivity" class="table table-striped">
          <thead>
            <tr>
              <th>#</th>
              <th>Nama Kegiatan</th>
